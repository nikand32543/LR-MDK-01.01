...
namespace DictBestStract
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Заполнение словаря
            Dictionary.Add("Дорогие", new List<string>() { "Феррари" });
            Dictionary.Add("Средние", new List<string>() { "Шевроле", "Мазда" });
            Dictionary.Add("Дешёвые", new List<string>() { "Копейка", "Семёрка", "Двенашка" });
