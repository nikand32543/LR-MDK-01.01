...
namespace Task_1._1
{
    public class Program
    {
        static void Main()
        {
            ...
            FixedSalaryEmployee Nikitos = new FixedSalaryEmployee();
            Nikitos.SetEmployee(Nikita);
            Nikitos.SetFixedSalary(110000);
            Console.WriteLine(Nikitos.CalculateSalary());

            HourlySalaryEmployee Kirya = new HourlySalaryEmployee();
            ...
            FreelancerEmployee Vlados = new FreelancerEmployee();
